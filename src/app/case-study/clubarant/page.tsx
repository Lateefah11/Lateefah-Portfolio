...
export default function BricklагeCaseStudy() {
  return (
    <div style={{ background: "#0D0D0D", minHeight: "100vh", overflowX: "hidden", color: "#f9f9f9" }}>
      ...
      <section style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
          {[
            { label: "Organization", value: "Bricklage" },
            { label: "Sector",       value: "PropTech, Real Estate" },
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <h2 style={{ fontFamily: "var(--font-anton)", fontSize: "36px", lineHeight: "45px", color: "#f9f9f9" }}>
            Designing Trust and Transparency in Real Estate Transactions
          </h2>
          <div style={{ fontFamily: "var(--font-geist-sans)", fontSize: "16px", color: "#c3c3c3" }}>
            <p style={{ lineHeight: "25px", marginBottom: "25px" }}>
              Bricklage is a property marketplace platform where buyers, sellers, and agents can list, discover, and verify properties across Nigeria — bringing clarity and confidence to real estate transactions.
            </p>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: "8px" }}>
            ...
            <a href="https://www.bricklage.com/" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "8px", textDecoration: "none" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        <section style={{ width: "100%", background: "#1e1e1e", lineHeight: 0 }}>
          <img src="/bricklage-landing.png" alt="Bricklage landing page" style={{ width: "100%", height: "auto", display: "block" }} />
        </section>

        <section style={{ width: "100%", background: "#1e1e1e", lineHeight: 0 }}>
          <img src="/bricklage-listings.png" alt="Bricklage property listings" style={{ width: "100%", height: "auto", display: "block" }} />
        </section>

        <section style={{ width: "100%", background: "#1e1e1e", lineHeight: 0 }}>
          <img src="/bricklage-search.png" alt="Bricklage property search" style={{ width: "100%", height: "auto", display: "block" }} />
        </section>

        <section style={{ width: "100%", background: "#1e1e1e", lineHeight: 0 }}>
          <img src="/bricklage-property.png" alt="Bricklage property detail" style={{ width: "100%", height: "auto", display: "block" }} />
        </section>

        <section style={{ width: "100%", background: "#1e1e1e", lineHeight: 0 }}>
          <img src="/bricklage-mobile.png" alt="Bricklage mobile screens" style={{ width: "100%", height: "auto", display: "block" }} />
        </section>

        <section style={{ width: "100%", background: "#1e1e1e", lineHeight: 0 }}>
          <img src="/bricklage-design-system.png" alt="Bricklage design system" style={{ width: "100%", height: "auto", display: "block" }} />
        </section>

        <section style={{ width: "100%", background: "#1e1e1e", lineHeight: 0 }}>
          <img src="/bricklage-lifestyle.png" alt="Bricklage lifestyle" style={{ width: "100%", height: "auto", display: "block" }} />
        </section>

        <section style={{ width: "100%", background: "#1e1e1e", lineHeight: 0 }}>
          <img src="/bricklage-brand.png" alt="Bricklage brand" style={{ width: "100%", height: "auto", display: "block" }} />
        </section>
